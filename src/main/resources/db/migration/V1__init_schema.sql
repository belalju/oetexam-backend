...
CREATE TABLE tests (
    ...
    description              TEXT,
    sub_test_type            ENUM('READING','LISTENING') NOT NULL,
...
CREATE TABLE test_parts (
    ...
    part_label          ENUM('PART_A','PART_B','PART_C') NOT NULL,
...
CREATE TABLE question_groups (
    ...
    title         VARCHAR(255),
    instructions  TEXT,
    question_type ENUM('TEXT_MATCHING','SHORT_ANSWER','GAP_FILL','MCQ_3','MCQ_4','NOTE_COMPLETION') NOT NULL,
    sort_order    INT         NOT NULL DEFAULT 0,
    PRIMARY KEY (id),
